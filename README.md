...
![GitHub top language](https://img.shields.io/github/languages/top/hayriaral/spring-boot-rest-example)	![Lines of code](https://img.shields.io/tokei/lines/github/hayriaral/spring-boot-rest-example)	![GitHub repo size](https://img.shields.io/github/repo-size/hayriaral/spring-boot-rest-example)    ![GitHub last commit](https://img.shields.io/github/last-commit/hayriaral/spring-boot-rest-example)	[![GitHub license](https://img.shields.io/github/license/hayriaral/spring-boot-rest-example)](https://github.com/hayriaral/spring-boot-rest-example/blob/master/LICENSE)
